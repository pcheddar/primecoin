...
static const int64 MAX_MONEY = 1000000 * COIN; // Primecoin: maximum of 1 million coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // Primecoin: 576 blocks found a day. Priority cutoff is 1 primecoin day / 250 bytes.
    }
